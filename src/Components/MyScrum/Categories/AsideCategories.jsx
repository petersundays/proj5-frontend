...
const handleCategorySearch = (e) => {
    ...
    const handleCategoryEdition = async () => {
        ...
        const editCategory = `http://localhost:8080/proj5_backend_war_exploded/rest/users/editCategory/${selectedCategory}`;
        try {
    ...
    const createCategory = async () => {
        ...
        const newCategoryUrl = "http://localhost:8080/proj5_backend_war_exploded/rest/users/newCategory";
    ...
    const deleteCategory = async () => {
        ...
        const deleteCategoryUrl = `http://localhost:8080/proj5_backend_war_exploded/rest/users/deleteCategory/${category.name}`;
