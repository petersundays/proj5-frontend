...
useEffect(() => {
    ...
    const titles = [t('totalUsers'), t('activeUsers'), t('inactiveUsers'), t('confirmedUsers'), t('notConfirmedUsers')];
    const taskTitles = [t('averageTasksPerUser'), t('totalTasksToDo'), t('totalTasksDoing'), t('totalTasksDone')];
    return (
        <>
            <div>
                <div id="dashboard" style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Card className="category-stat-card">
                        <Card.Body>
                            <Card.Title>{t('categoriesByTasks')}</Card.Title>
                ...
                <div className='dashboard-charts'>
                    <Card className="concluded-tasks-card">
                        <Card.Body>
                            <Card.Title>{t('concludedTasksOverTime')}</Card.Title>
                    ...
                    <Card className="registered-users-card">
                        <Card.Body>
                            <Card.Title>{t('activeUsers')}</Card.Title>
                            <ResponsiveContainer width="100%" height={300}>
                                <LineChart
